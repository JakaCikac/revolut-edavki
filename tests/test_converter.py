...
def test_kdvp_sell_filtering(sample_transactions, sample_company_info, test_tax_info):
    ...
    create_kdvp_xml(
        sample_transactions,
        2024,
        test_tax_info["tax_number"],
        test_tax_info["taxpayer_type"],
    )
...
def test_kdvp_sell_year_filtering(
    sample_transactions, sample_company_info, test_tax_info
):
...
def test_kdvp_currency_conversion(
    sample_transactions, sample_company_info, test_tax_info
):
...
def test_dividend_year_filtering(
    sample_transactions, sample_company_info, test_tax_info
):
...
def test_dividend_amount_format(
    sample_transactions, sample_company_info, test_tax_info
):
...
def test_ifi_currency_conversion(
    sample_transactions, sample_company_info, test_tax_info
):
...
def test_empty_transactions(test_tax_info):
    ...
    create_kdvp_xml(
        empty_df, 2024, test_tax_info["tax_number"], test_tax_info["taxpayer_type"]
    )
    # TODO: Add XML validation
...
def test_missing_company_info(sample_transactions, test_tax_info):
    ...
    empty_company_info = pd.DataFrame(
