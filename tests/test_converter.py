...
def test_tax_info():
    ...
    return {"tax_number": "12345678", "taxpayer_type": "FO"}
...
def sample_transactions():
    data = {
        ...
        "Type": ["DIVIDEND", "BUY", "SELL", "DIVIDEND", "BUY", "SELL", "DIVIDEND", "BUY", "SELL", "BUY", "SELL"],
        "Ticker": ["GRMN", "AAPL", "MSFT", "GRMN", "NVDA", "NVDA", "AAPL", "VWCE", "AAPL", "MSFT", "MSFT"],
        "Quantity": [100, 50, 30, 100, 20, 10, 50, 5, 25, 40, 20],
        "Price per share": [0, 180.75, 420.25, 0, 450.25, 550.75, 0, 95.25, 175.50, 390.25, 425.75],
        "Total Amount": [1.46, -9037.50, 12607.50, 1.46, -9005.00, 5507.50, 1.43, -476.25, 4387.50, -15610.00, 8515.00],
        "Currency": ["USD", "USD", "USD", "USD", "USD", "USD", "USD", "EUR", "USD", "USD", "USD"],
        "FX Rate": [1.0700, 1.0800, 1.0900, 1.0750, 1.0850, 1.0950, 1.0800, 1.0000, 1.0750, 1.0900, 1.1000],
    }
...
def sample_company_info():
    data = {
        ...
        "ISIN": ["CH0114405324", "US0378331005", "US5949181045", "US67066G1040", "IE00BK5BQT80"],
    }
...
def test_dividend_year_filtering(sample_transactions, sample_company_info, test_tax_info):
    ...
    create_div_xml(
        sample_transactions, sample_company_info, 2024, test_tax_info["tax_number"], test_tax_info["taxpayer_type"]
    )
    # TODO: Add XML validation
...
def test_missing_company_info(sample_transactions, test_tax_info):
    ...
    create_div_xml(
        sample_transactions, empty_company_info, 2024, test_tax_info["tax_number"], test_tax_info["taxpayer_type"]
    )
    # TODO: Add XML validation
